...
function dragOverHandler(ev) {
    ev.preventDefault();
    document.getElementById('upload-area').classList.remove('bg-transparent')
    document.getElementById('upload-area').classList.add('bg-blue-100')
}

function dragLeaveHandler(ev) {
    document.getElementById('upload-area').classList.remove('bg-blue-100');
    document.getElementById('upload-area').classList.add('bg-transparent');
}
